...
```md
[plotting.py](/absolute/path/to/dimelo-toolkit/dimelo/plotting.py)
```
...
```text
/absolute/path/to/dimelo-toolkit/docs/superpowers/plans/2026-04-01-region-contrasts-plotting.md
```
